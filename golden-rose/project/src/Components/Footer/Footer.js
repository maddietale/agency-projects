...
import { CustomLink, FlexWrapper, GoldenTitle4, GoldenTitle6 } from '../StyledComponent';
// IMG
        ...
        <div className={Style.container}>
            <div className={Style.footerWrapper}>
                <div className={Style.clm1}>
                    ...
                    <h4 className={Style.title1}><GoldenTitle4 />، حامی حقوق زنان است.</h4>
                ...
                <div className={Style.clm2}>
                    ...
                    <CustomLink className={Style.item2} display={"block"}>درباره <GoldenTitle6 /></CustomLink>
